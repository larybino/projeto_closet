  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        Rotas.detalhesRoupas:
            (context) => WidgetDetalhesRoupas(
              roupa: DTORoupas(),
            ), // Replace with a valid DTORoupas object
        ...
        Rotas.detalhesAcessorios:
            (context) => WidgetDetalhesAcessorios(
              acessorios: DTOAcessorios(),
            ), // Replace with a valid DTOAcessorios object
        Rotas.cadastrarSapato: (context) => WidgetCadastroSapato(),
        Rotas.detalhesSapatos:
            (context) => WidgetDetalhesSapatos(
              sapato: DTOSapato(),
            ), // Replace with a valid DTOSapato object
      },
    );
  }
}
