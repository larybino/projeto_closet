      ...
      drawer: Drawer(
        child: ListView(
          ...
          children: [
            ...
            criarMenu(icone: Icons.ring_volume, rotulo: 'Cadastro de Acessorios', rota: Rotas.acessorio),
            criarMenu(icone: Icons.person, rotulo: 'Cadastro de Looks', rota: Rotas.look),
            criarMenu(icone: Icons.store, rotulo: 'Cadastro de Marcas', rota: Rotas.sapato),
